...
const incrementHandler = (id, formElm) =>{
    const value = Number(formElm.querySelector('.increment').value)
    store.dispatch(increment({id, value}))
    formElm.querySelector('.increment').innerHTML=""
}

const decrementHandler = (id, formElm)=>{
    const value = Number(formElm.querySelector('.decrement').value)
    store.dispatch(decrement({id, value}))
    formElm.querySelector('.decrement').innerHTML=""
...
const matchHtml = (match) => {
    ...
    <div class="match">
    <div class="wrapper">
        <button class="delete" onclick = "deletematchHandler(${match.id})">
